...
const Feature = () => {
  ...
  return (
    ...
    <div className="py-12  text-gray-100 sm:py-12">
        ...
        <div
            className="grid max-w-4xl lg:max-w-6xl grid-cols-1 mx-auto mt-8 text-center gap-y-4 sm:gap-x-8 sm:grid-cols-2 lg:grid-cols-2 sm:mt-12 lg:mt-14 sm:text-left">
            <div className="relative">
                ...
                <div className="relative overflow-hidden bg-white shadow-lg rounded-xl h-full">
                    <div className="p-9">
                        ...
                        <h3 className="mt-6 text-2xl font-bold text-gray-900 sm:mt-10 lg:mt-1 ">Insights</h3>
                        </div>
            ...
            <div className="overflow-hidden bg-white shadow-lg rounded-xl border">
                <div className="p-9"> <div className="flex lg:gap-5">
                <svg className="w-12 h-12 mx-auto text-gray-400 sm:mx-0" viewBox="0 0 24 24" fill="none"
